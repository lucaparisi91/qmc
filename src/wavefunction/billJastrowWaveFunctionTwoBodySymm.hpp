...
template<class X,class comp>
void bill_jastrow_wavefunction_two_body_symmetric<X,comp>::laplacianMinusGradientSquaredLogWave(const typename bill_jastrow_wavefunction_two_body_symmetric<X,comp>::all_particles_t & p,typename bill_jastrow_wavefunction_two_body_symmetric<X,comp>::grad_t & grad,typename bill_jastrow_wavefunction_two_body_symmetric<X,comp>::value_t & e,bill_jastrow_wavefunction_two_body_symmetric<X,comp>::value_t & waveValue)
{
  typedef typename grad_t::gradParticles_t gradParticles_t;
